Rails.application.routes.draw do
  ...
  resources :equips,          only: [:index] do collection do get "json"; get "pno_text"  end end
  ...
  resources :profiles,        only: [:index] do collection do get "json"; get "pno_text"  end end
