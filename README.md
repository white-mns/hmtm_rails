# Secret Sphereデータ小屋　表示用Railsアプリ
Secret Sphereデータ小屋は[Secret Sphere](http://www.sssloxia.jp/index.html)を解析して得られるデータを扱った情報サイトです。  
データ小屋の解析部分については[別リポジトリ](https://github.com/white-mns/hmtm_parse)を参照ください。

# サイト
実際に動いているサイトです。
[Secret Sphereデータ小屋](https://data.teiki.org/hmtm/)
...
・このソースコードをダウンロードします。  
    ...
    git clone git://github.com/white-mns/hmtm_rails.git
...
あとは[解析プログラム](https://github.com/white-mns/hmtm_parse)側に圧縮ファイルを用意し、解析とアップロード機能を追加してデータを入れれば新しい解析項目が公開されます。
